...
Usage:
    python train.py --dataset <path_to_dataset> --shots cut,drive,flick,misc,pull,slog,sweep
    
Example:
    python train.py --dataset "C:\\Users\\User\\Downloads\\Cricket-Shots" --shots cut,drive,flick,misc,pull,slog,sweep
"""
...
project_root = current_dir.parent.parent.parent.parent.parent  # Navigate to CricAI-API root
...
def main():
    ...
    try:
        ...
        print("="*80)
        print(f"Models saved to assets/trained_models/video_classifier/")
